  ...
  return {
    ...
    template: `<div class="header">
      ...
      <div class="header-icons">
        ...
        <a href='mailto:someone@{{email}}'><span ng-if="email" class="md-subhead page-subhead"><i class="fa fa-lg fa-envelope"></i>{{email}}</span></a>
        <a href='github.com/{{github}}'><span ng-if="github" class="md-subhead page-subhead"><i class="fa fa-lg fa-github"></i>{{github}}</span></a>
        <a href='linkedin.com/{{github}}'><span ng-if="linkedin" class="md-subhead page-subhead"><i class="fa fa-lg fa-linkedin-square"></i>{{linkedin}}</span></a>
      </div>
    </div>`
  }
})
